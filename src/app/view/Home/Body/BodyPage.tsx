            ...
            {isLoading ?
                ...
                <>
                    ...
                    {movie ?
                        ...
                        :
                        <div>
                            <BodySlider categoryMovie={moviesCategory.romantic} movies={romanticMovies} onClick={handleSearch} />
                            <BodySlider categoryMovie={moviesCategory.comedy} movies={comedyMovies} onClick={handleSearch} />
                        </div>
                    }
                </>
            }
